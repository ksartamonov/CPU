...
int  DisAssemble(int* Commands, FILE* disassembled_cmds, int NumberOfcommands)
{
  ...
  {
    if ( Commands[com_num] == CMD_JMP || Commands[com_num] == CMD_JB || Commands[com_num] == CMD_JBE || Commands[com_num] == CMD_JA || Commands[com_num] == CMD_JAE || Commands[com_num] == CMD_JE || Commands[com_num] == CMD_JNE)
    {
